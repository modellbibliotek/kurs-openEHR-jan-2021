...
1. In the `Race name' field of the template, we want to list the different variants of the Vätternrundan so that it will be smooth for the staff. Select "Free text" then "Edit values" copy the entire list below, and when you are in the top blank field then  paste the previously copied list and press "Save".
